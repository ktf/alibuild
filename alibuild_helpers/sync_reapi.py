...
class REAPIRemoteSync(Boto3RemoteSync):
  ...
  *action* hash and hardcodes the CERN endpoint, this backend (scheme
  ...
  def __init__(self, remoteStore, writeStore, architecture, workdir,
    ...
    legacy_ep, self.legacyWriteStore = (self._parse_reapi_url(legacyStore, scheme)
                                        if legacyStore else ("", self.writeStore))
    ...
    self.casPublicUrl = casPublicUrl
    dieOnError(self.legacyWriteStore != self.writeStore and not casPublicUrl,
